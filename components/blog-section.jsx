...
const articles = [
  {
    title: "Rental tips: How to maximize your property income",
    category: "Guides",
    date: "Jan 30, 2026",
    image: "/placeholder.svg",
  },
  {
    title: "The Homie app is now available on all platforms!",
    category: "Updates",
    date: "Jan 30, 2026",
    image: "/placeholder.svg",
  },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Stay informed with our latest updates, insightful articles, and expert opinions on rental trends, property
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {articles.map((article, index) => (
            <div key={index} className="group cursor-pointer">
              <div className="rounded-2xl overflow-hidden border border-border mb-4 aspect-[4/3] relative">
                <Image
                  src={article.image}
                  alt={article.title}
                  fill
